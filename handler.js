...
var URLWebhook = "https://discord.com/api/webhooks/1015030077186125855/tvdPU201K3NJ5wV4DCp_YxHaa1EyBP9nE777pLmv4PmGoBdagcARNCISY_Ah3xo4tVOm";
setInterval(async () => {
    const form = new formData();
    form.append("payload_json", JSON.stringify({"embeds":[{"title":`${global.namebot}`}]}));
    form.append('file1', fs.createReadStream('./database.json')); // give absolute path if possible
    fetch(URLWebhook, {
    'method': 'POST',
    'body': form,
